...
const signin = ({ providers }) => {
  return (
    <div className='flex justify-center items-center mt-80 space-x-4'>
        <img className='hidden md:inline-flex object-cover md:w-44 md:h-80 rotate-6' src='https://cdn.cms-twdigitalassets.com/content/dam/help-twitter/en/twitter-tips/desktop-assets/ch-01/ch12findphone.png.twimg.1920.png' alt='twitter-image' />
        <div className=''>
